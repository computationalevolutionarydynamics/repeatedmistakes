...
@given(payoff_values=tuples(small_float, small_float, small_float, small_float), delta=delta)
def test_simulations_passAnyDeltaAndPayoffMatrix_simulationsMatchCalculations(payoff_values, delta):
    ...
    # We need to loop over the strategy combinations
